...
import de.timfreiheit.mozart.model.getStreamDuration
...
class MiniControllerView @JvmOverloads constructor(
    ...
    private fun updateProgress() {
        val lastPlaybackState = lastPlaybackState ?: return
        ...
        setStreamPosition(currentPosition.toInt(), lastPlaybackState.getStreamDuration().toInt())
    }
